...
39. Var-call-prime -> #initialize_arg_count ( Args ) #set_args #update_displays #func_call #get_return_val #retrieve_display | Var-prime
40. Var-prime -> #assign_id [ Expression #displace ] #get_indirect_value | #apply_id EPSILON
41. Factor-prime -> #initialize_arg_count ( Args ) #set_args #update_displays #func_call #get_return_val #retrieve_display | EPSILON
