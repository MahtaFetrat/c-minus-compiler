...
23. B -> #assign_id = #report_assignment Expression #assign | #assign_id [ Expression #displace ] H | #apply_id Simple-expression-prime
...
41. Factor-prime -> #initialize_arg_count ( Args ) #pruntime_top #update_displays #set_args #func_call #get_return_val #retrieve_display | #report_mistype EPSILON
