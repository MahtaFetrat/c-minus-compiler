...
DFA_DICT = {
    ...
    'transitions': [
        ...
        {'id': 2, 'state_src_id': 1, 'state_dst_id': 2, 'symbols': _SYMBOLS + _WHITESPACES + _EOF},
        ...
        {'id': 17, 'state_src_id': 15, 'state_dst_id': 15, 'symbols': diff(_ALL + _ADD, _STAR + _EOF)},
        ...
        {'id': 21, 'state_src_id': 16, 'state_dst_id': 15, 'symbols': diff(_ALL + _ADD, _STAR)},
        {'id': 22, 'state_src_id': 14, 'state_dst_id': 18, 'symbols': _SLASH},
        {'id': 23, 'state_src_id': 18, 'state_dst_id': 18, 'symbols': diff(_ALL + _ADD, _EOF_COMMENT)},
        ...
        {'id': 23, 'state_src_id': 18, 'state_dst_id': 18, 'symbols': diff(_ALL + _ADD, _EOF_COMMENT)},
        {'id': 22, 'state_src_id': 14, 'state_dst_id': 22, 'symbols': diff(_ALL + _ADD, _SLASH + _STAR)},
    ],
}
